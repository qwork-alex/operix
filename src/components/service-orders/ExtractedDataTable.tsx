...
export function ExtractedDataTable({
  ...
  // Pre-resolve technician user_id from OCR text by case-insensitive name match.
  // After this, `row.technician` will hold the technicians.user_id whenever a match is found,
